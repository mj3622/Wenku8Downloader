...
describe('website download links', () => {
  it('matches electron-builder artifact names', () => {
    const links = createDownloadLinks('2.1.0')
    assert.deepEqual({
      ...
      macArm64: 'Wenku8Downloader-2.1.0-macOS-arm64.dmg',
      macX64: 'Wenku8Downloader-2.1.0-macOS-x64.dmg',
      windowsX64: 'Wenku8Downloader-2.1.0-Windows-x64.exe',
      releases: 'https://github.com/mj3622/Wenku8Downloader/releases',
    })
  })

  it('rejects invalid or prerelease versions', () => {
    assert.throws(() => createDownloadLinks('v2.1.0'))
    assert.throws(() => createDownloadLinks('2.1.0-beta.1'))
  })
})
