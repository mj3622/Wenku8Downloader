...
<p align="center">
  <img src="resources/ShowPage.png" alt="应用截图" width="800" />
</p>
...
- **Windows** — 下载 `.exe` 即可直接运行，无需安装

## 使用

1. **配置账号** — 在「配置」页填写文库用户名与密码，保存后自动登录获取 Cookie
2. **设置下载路径** — 在「配置」→「下载设置」中可自定义文件保存位置，留空则默认保存至系统下载文件夹
3. **检索作品** — 在「检索」页输入编号、作者或书名查找目标小说
4. **选择下载** — 进入书籍详情页，选择整本下载或勾选所需分卷
5. **管理任务** — 在「下载历史」页查看进度，点击文件夹图标可打开文件所在目录，失败任务可重试
