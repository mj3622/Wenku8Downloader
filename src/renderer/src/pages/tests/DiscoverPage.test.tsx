...
describe('DiscoverPage', () => {
  it('places the three-column ranking band before the full-width cover grids', async () => {
    ...
    expect(container.querySelector('a[href="/discover/ranking/allvote?page=1"]')).not.toBeNull()
    expect(container.querySelector('a[href="/discover/ranking/monthvote?page=1"]')).not.toBeNull()
    expect(container.querySelector('a[href="/discover/ranking/dayvote?page=1"]')).not.toBeNull()
    expect(container.querySelector('a[href="/discover/ranking/size?page=1"]')).not.toBeNull()
    expect(container.querySelector('a[href="/discover/annual/2026"]')).not.toBeNull()
